...
[![Deploy with Clawnify](https://app.clawnify.com/deploy-button.svg)](https://app.clawnify.com/deploy?repo=clawnify/OpenTable)
...
```bash
git clone https://github.com/clawnify/OpenTable.git
cd open-table
pnpm install
pnpm run dev
```
